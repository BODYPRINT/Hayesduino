...
//Modified library files for Hayesduino
...
#define BUFFER_1024	1
#define BUFFER_2048	2
#define BUFFER_4096	3

// Added compiler directive to change the buffer size
// Change the next line one of the above 3 buffer size options
#define SELECT_BUFFER	BUFFER_1024

#if SELECT_BUFFER == BUFFER_1024
  #define MAX_SOCK_NUM 4
#elif SELECT_BUFFER == BUFFER_2048  
  #define MAX_SOCK_NUM 4
#else
...
private:
  static const uint8_t  RST = 7; // Reset BIT
    ...
    static const uint16_t SMASK = 0x03FF; // Tx buffer MASK
    static const uint16_t RMASK = 0x03FF; // Rx buffer MASK
  public:
    static const uint16_t SSIZE = 1024; // Max Tx buffer size
  private:
    static const uint16_t RSIZE = 1024; // Max Rx buffer size
#elif SELECT_BUFFER == BUFFER_2048  
    static const int SOCKETS = 4;
  ...
  private:
    ...
    static const uint16_t SMASK = 0x0FFF; // Tx buffer MASK
    static const uint16_t RMASK = 0x0FFF; // Rx buffer MASK
  public:
